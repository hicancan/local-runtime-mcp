...
func TestValidate(t *testing.T) {
	...
	invalid := []Action{{Kind: "activate"}, {Kind: "activate", TargetID: "win-1-1", StateID: "s1"}, {Kind: "click", StateID: "s1", X: &x1, Y: &y2, Button: "fourth"}, {Kind: "click", StateID: "s1"}, {Kind: "click", StateID: "s1", ElementRef: "s1:u1", X: &x1, Y: &y2}, {Kind: "type_text", StateID: "s1"}, {Kind: "set_value", StateID: "s1"}, {Kind: "press_key", StateID: "s1"}, {Kind: "scroll", StateID: "s1"}, {Kind: "unknown", StateID: "s1"}}
